...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    figure.mb-5
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/W7-HlELqAg0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
    ...
    p.mb-5 Las máquinas CNC generalmente traen incluido un simulador, sin embargo, podemos encontrar algunos junto con el paquete <em>software</em> de CAM, estos de acuerdo con la estructura del control de máquina funcionan de una u otra forma. A continuación, un ejemplo:
    ...
    ImagenInfograficaB.color-acento-botones.mb-5
      ...
      .tarjeta.colormodal(x="68%" y="46%" numero="4" tooltip='NC Viewer')
        .row.justify-content-center.mb-5.p-5
          ...
          .col-6
            p.color-texto.h4.mt-5 NC Viewer:
